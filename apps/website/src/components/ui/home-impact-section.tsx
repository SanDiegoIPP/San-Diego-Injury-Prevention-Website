...
const impactCards: ImpactPlanItem[] = [
  {
    ...
    icon: BookOpen,
    href: "https://san-diego-injury-prevention-website.vercel.app/programs", // paste link here
  },
  {
    title: "Health Fairs",
    description:
  ...
  },
  {
    ...
    icon: Handshake,
    href: "https://san-diego-injury-prevention-website.vercel.app/more/partner-with-us", // paste link here
  },
];
